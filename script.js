...
const intitialTranslateLTR = -48*4;
const intitialTranslateRTL = 32*4;
...
function setupIntersectionObserver(element, isLTR, speed) {
    ...
    function scrollHandler(){
        ...
        if(isLTR){
            totalTranslate = translateX + intitialTranslateLTR;
        }else{
            totalTranslate = -(translateX + intitialTranslateRTL);
        }
